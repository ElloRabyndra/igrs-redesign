...
For project-specific information (tech stack decisions, feature scope, architecture details, conventions unique to the project), use a **`PROJECT_CONTEXT.md`** file in the project root.
